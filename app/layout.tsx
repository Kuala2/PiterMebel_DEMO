...
export const metadata: Metadata = {
  ...
  description: "Производство кухонь, гардеробных и корпусной мебели на заказ в Санкт-Петербурге. Собственный цех с 2005 года. Офис: пл. Стачек, 9. Бесплатный выезд мастера на замер.",
  keywords: [
    "ПитерМебель",
    "мебель на заказ СПб",
