    ...
    <div>
      ...
      <CatalogEditorial
        ...
        items={[
          ...
          { title: "Подтверждённая отделка", text: "В карточках указаны натуральный шпон дуба, радиусные фасады, влагостойкий МДФ с PUR-клеем, алюминиевый профиль, безопасное остекление, акриловый камень и LED-подсветка." },
        ...
        links={[
          ...
          { href: "/projects/bathroom-pur-vanity", label: "Мебель для ванной" },
