...
export async function submitMeasureRequest(
  ...
  return {
    success: true,
    message: "Спасибо! Заявка на консультацию и предварительный расчет успешно принята. Специалист свяжется с вами в ближайшее время для обсуждения деталей проекта и согласования встречи в офисе студии."
  };
}
