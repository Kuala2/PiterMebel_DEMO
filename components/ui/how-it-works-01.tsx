...
const STEPS: StepItem[] = [
  ...
  },
  {
    ...
    desc: "Штатный мастер готовит коммуникации заранее по схеме кухонного проекта.",
    details: [
      "Штробление строго по чертежу",
      "Вывод розеток под проект",
      "Чистовая уборка после работ",
    ],
    icon: (
      <svg
        width="22"
      ...
      <div className="container">
        ...
        <div className="how-it-works-guarantee">
          <p className="how-it-works-guarantee-text">
            ...
            если розетка не совпала или слив упёрся в ящик — за это отвечаем мы,
            а не отделочники. Мы проектируем, готовим стены, собираем и
            подключаем всё сами.
          </p>
        </div>
      </div>
