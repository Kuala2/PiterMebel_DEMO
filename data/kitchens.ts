...
export const KITCHENS: Kitchen[] = [
  ...
  },
  {
    ...
    facade: "МДФ в эмали по RAL: изумрудный матовый и шелковистый белый",
    facadeMaterialCategory: "enamel",
    worktop: "Влагостойкая матовая столешница с угловой врезной мойкой",
    feature: "Классическая фрезеровка, стеклянные витрины со шпросами и латунные ручки-ракушки",
    price: 295000,
    pricePerMeter: "от 67 000 ₽ / м.п.",
    story: [
      "Интерьер кухни в неоклассическом стиле с высокими потолками. Стояла задача создать благородное, выразительное пространство, объединив винтажную эстетику с современной эргономикой встроенной техники.",
      "Нижний ярус выполнен в насыщенной изумрудной эмали с объемной фрезеровкой и латунной фурнитурой. Верхний белый ярус визуально облегчает гарнитур, а застекленные витрины со шпросами и декоративной балюстрадой подчеркивают парадный характер кухни."
    ]
  },
  {
    slug: "velvet-matte",
    title: "Вельвет (МДФ Velvet)",
    cover: "/img/kitchens/velvet-matte/photo_1.jpg",
    gallery: [
      "/img/kitchens/velvet-matte/photo_1.jpg",
      "/img/kitchens/velvet-matte/photo_2.jpg"
    ],
    facade: "МДФ с антипальчиковым суперматовым покрытием Velvet",
    facadeMaterialCategory: "fenix",
    worktop: "Столешница и фартук из фактурного камня с мраморным рисунком",
    feature: "Скрытый черный профиль Gola без ручек, монолитный фартук под мрамор и черный цоколь",
    price: 255000,
    pricePerMeter: "от 63 000 ₽ / м.п.",
    story: [
      "Пространство с правильной геометрией требовало современного минималистичного гарнитура без лишних визуальных деталей. Было важно обеспечить защиту фасадов от отпечатков при повседневном использовании.",
      "Мы применили инновационный пластик МДФ Velvet с шелковистой текстурой Soft-Touch. Горизонтальный скрытый профиль Gola черного цвета подчеркивает строгие линии, а бесшовный фартук под мрамор добавляет интерьеру утонченную глубину."
    ]
  },
  {
    slug: "sherman-cognac",
    title: "Шерман (Глянец & Egger)",
    ...
    facade: "Глянцевый МДФ пластик & декор Egger «Дуб Шерман коньяк коричневый»",
    facadeMaterialCategory: "veneer",
    worktop: "Влагостойкая столешница Egger «Дуб Шерман коньяк коричневый»",
    feature: "Высокая подсвеченная витрина в черном профиле, встроенный винный шкаф и зеркальный глянец",
    price: 320000,
    pricePerMeter: "от 72 000 ₽ / м.п.",
    story: [
      "Просторная кухня-столовая требовала эффектного контраста между современным зеркальным глянцем и природной текстурой теплого дерева. Требовалось также выделить вечернюю витринную зону с подсветкой посуды.",
      "В проекте скомбинированы белоснежные глянцевые фасады и выразительный австрийский декор Egger «Дуб Шерман коньяк». Вертикальная застекленная витрина с теплым янтарным светом и торцевой винный шкаф превратили гарнитур в доминанту всей квартиры."
    ]
  }
];
